...
class SlidePuzzleModel {
    ...
    private ProcessAction dim;
    private SlidePuzzleGUI slidPuzzleGUI;

    public SlidePuzzleModel(ProcessAction dim) {
        this.dim = dim;
    }
    ...
    public SlidePuzzleModel() {
      ...
      public SlidePuzzleModel(SlidePuzzleGUI slidPuzzleGUI) {
          this.slidPuzzleGUI = slidPuzzleGUI;

        reset();               // Initialize and shuffle tiles.
    }//end cons

    public void reset() {
        dim = new ProcessAction();
        System.out.println("dim1: " + dim.getDim1());
        System.out.println("dim2: " + dim.getDim2());
        if (dim.getDim1() != 0) {
            rows = dim.getDim1();
            cols = dim.getDim2();
        }
